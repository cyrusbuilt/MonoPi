...
namespace CyrusBuilt.MonoPi.Devices.Garage
{
	...
	/// </summary>
	public abstract class GarageDoorOpenerBase : OpenerDevice, IGarageDoorOpener
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Devices.Garage.GarageDoorOpenerBase"/>
		...
		/// </param>
		protected GarageDoorOpenerBase(IRelay relay, ISensor doorSensor, SensorState doorSensorOpenState)
		...
		/// </param>
		protected GarageDoorOpenerBase(IRelay relay, ISensor doorSensor, SensorState doorSensorOpenState, ISwitch lok)
