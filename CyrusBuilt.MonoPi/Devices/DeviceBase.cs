...
namespace CyrusBuilt.MonoPi.Devices
{
	...
	public abstract class DeviceBase : IDevice
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/>
		...
		/// <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/>. The
		/// <see cref="Dispose"/> method leaves the <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/>
		/// in an unusable state. After calling <see cref="Dispose"/>, you must release all references
		/// to the <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/> so the garbage collector can
		/// reclaim the memory that the
		/// <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/> was occupying.
		/// </remarks>
		...
		/// <see cref="CyrusBuilt.MonoPi.Devices.DeviceBase"/>.
		/// </summary>
		/// <returns>
