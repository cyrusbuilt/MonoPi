...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4542.
	/// </summary>
	public class MCP4542 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4542"/>
		/// class with the I2C device that is the connection to MCP4542,
		/// whether the address pin A0 is high or not, whether the address
		/// pin A1 is high or not, and the way to handle non-volatile I/O.
		/// </summary>
		/// <param name="device">
		...
		/// </exception>
		public MCP4542(II2CBus device, Boolean pinA0, Boolean pinA1, MicrochipPotNonVolatileMode nonVolatileMode)
			: base(device, pinA0, pinA1, PIN_NOT_AVAILABLE,
