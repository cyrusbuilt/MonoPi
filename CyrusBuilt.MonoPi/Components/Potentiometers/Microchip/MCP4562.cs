...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4562.
	/// </summary>
	public class MCP4562 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4562"/>
		/// class with the I2C device that is the connection to MCP4562,
		...
		/// </exception>
		public MCP4562(II2CBus device, Boolean pinA0, Boolean pinA1, MicrochipPotNonVolatileMode nonVolatileMode)
