...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4532.
	/// </summary>
	public class MCP4532 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4532"/>
		/// class with the I2C device that is the connection to MCP4532,
		...
		/// </exception>
		public MCP4532(II2CBus device, Boolean pinA0, Boolean pinA1, Int32 initialValue)
