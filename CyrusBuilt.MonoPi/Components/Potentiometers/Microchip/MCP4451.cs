...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4451.
	/// </summary>
	public class MCP4451 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4451"/>
		/// class with the I2C device that is the connection to MCP4451,
		...
		/// </exception>
		public MCP4451(II2CBus device, Boolean pinA0, Int32 initialValue)
