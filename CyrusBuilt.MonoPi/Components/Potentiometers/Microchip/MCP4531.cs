...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4531.
	/// </summary>
	public class MCP4531 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4531"/>
		/// class with the I2C device that is the connection to MCP4531,
		...
		/// </exception>
		public MCP4531(II2CBus device, Boolean pinA0, Int32 initialValue)
