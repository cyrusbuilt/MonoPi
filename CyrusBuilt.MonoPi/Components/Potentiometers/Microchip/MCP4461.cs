...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4461.
	/// </summary>
	public class MCP4461 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4461"/>
		/// class with the I2C device that is the connection to MCP4461,
		...
		/// </exception>
		public MCP4461(II2CBus device, Boolean pinA0, Int32 initialValue)
