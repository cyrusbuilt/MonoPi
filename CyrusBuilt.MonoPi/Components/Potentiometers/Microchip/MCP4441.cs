...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4441.
	/// </summary>
	public class MCP4441 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4441"/>
		/// class with the I2C device that is the connection to MCP4441,
		...
		/// </exception>
		public MCP4441(II2CBus device, Boolean pinA0, Int32 initialValue)
