...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4332.
	/// </summary>
	public class MCP4432 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4432"/>
		/// class with the I2C device that is the connection to MCP4432,
		...
		/// </exception>
		public MCP4432(II2CBus device, Boolean pinA0, Int32 initialValue)
