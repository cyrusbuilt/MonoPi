...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4442.
	/// </summary>
	public class MCP4442 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4442"/>
		/// class with the I2C device that is the connection to MCP4442,
		...
		/// </exception>
		public MCP4442(II2CBus device, Boolean pinA0, Int32 initialValue)
