...
{
	/// <summary>
	/// Hardware device abstraction component for the Microchip MCP4452.
	/// </summary>
	public class MCP4452 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4452"/>
		/// class with the I2C device that is the connection to MCP4452,
		...
		/// </exception>
		public MCP4452(II2CBus device, Boolean pinA0, Int32 initialValue)
