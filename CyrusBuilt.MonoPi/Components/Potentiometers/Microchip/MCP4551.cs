...
namespace CyrusBuilt.MonoPi.Components.Potentiometers.Microchip
{
	...
	/// </summary>
	public class MCP4551 : MicrochipPotentiometerBase
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.MonoPi.Components.Potentiometers.Microchip.MCP4551"/>
		/// class with the I2C device that is the connection to MCP4551,
		...
		/// </exception>
		public MCP4551(II2CBus device, Boolean pinA0, Int32 initialValue)
