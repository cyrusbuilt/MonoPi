...
{
	/// <summary>
	/// A component that is an abstraction of a momentary switch. This is an
	/// implementation of <see cref="CyrusBuilt.MonoPi.Components.Switches.MomentarySwitchBase"/>.
	/// </summary>
	public class MomentarySwitchComponent : MomentarySwitchBase
	{
		...
		private void BackgroundExecutePoll() {
			...
			if ((this._pollThread == null) || (!this._pollThread.IsAlive)) {
				...
				this._pollThread.Name = "MomentarySwitchStatePollExecutive";
		...
		/// <see cref="CyrusBuilt.MonoPi.Components.Switches.MomentarySwitchComponent"/>.
		/// </summary>
		/// <returns>
