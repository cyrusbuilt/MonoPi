...
namespace CyrusBuilt.MonoPi.IO.I2C
{
	...
	public class I2CBus : II2CBus
	{
		...
		/// <summary>
		/// Releases all resource used by the <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/>
		/// object.
		/// </summary>
		...
		/// <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/> is reclaimed by garbage collection.
		/// </summary>
		~I2CBus() {
			this.Dispose(false);
		}
		...
		/// <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/>. The <see cref="Dispose"/>
		/// method leaves the <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/> in an
		/// unusable state. After calling <see cref="Dispose"/>, you must release
		/// all references to the <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/>
		/// so the garbage collector can reclaim the memory that the
		/// <see cref="CyrusBuilt.MonoPi.IO.I2C.I2CBus"/> was occupying.
		/// </remarks>
		public void Dispose() {
			this.Dispose(true);
